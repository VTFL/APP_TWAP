    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        myButton.addListener(new GpioPinListenerDigital() {
            ...
            public void handleGpioPinDigitalStateChangeEvent(GpioPinDigitalStateChangeEvent event) {
                ...
                System.out.println(" --> GPIO 2 PIN STATE CHANGE: " + event.getPin() + " = " + event.getState());
        ...
        myButton2.addListener(new GpioPinListenerDigital() {
            @Override
            public void handleGpioPinDigitalStateChangeEvent(GpioPinDigitalStateChangeEvent event) {
                System.out.println(" --> GPIO 0 PIN STATE CHANGE: " + event.getPin() + " = " + event.getState());
        ...
        // provision gpio pin #02 as an input pin with its internal pull down resistor enabled
        final GpioPinDigitalInput myButton3 = gpio.provisionDigitalInputPin(RaspiPin.GPIO_01, PinPullResistance.PULL_DOWN);
        ...
        myButton3.addListener(new GpioPinListenerDigital() {
            ...
            public void handleGpioPinDigitalStateChangeEvent(GpioPinDigitalStateChangeEvent event) {
                // display pin state on console
                System.out.println(" --> GPIO 1 PIN STATE CHANGE: " + event.getPin() + " = " + event.getState());
